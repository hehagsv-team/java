...
import org.hcl.harika.schoolMgmt.BestTeacher;
...
public class BestTeacherTest {
	...
	public void test_BestTeacher_Case4() throws SQLException {
		/*
		 * BestTeacher bestteacher = new BestTeacher(); Scanner scan1 = new
		 * Scanner("4"); when(e.execute4thquery(rs,"HISTORY")).thenReturn("20"); String
		 * result = bestteacher.classdetails(queryClass, e,conn,"20", scan1, true);
		 * System.out.println(result); assertEquals("20",result);
		 */
	}
	@Test
