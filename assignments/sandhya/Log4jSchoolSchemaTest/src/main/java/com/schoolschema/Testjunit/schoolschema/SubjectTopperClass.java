...
public class SubjectTopperClass {
	static Logger log=Logger.getLogger("SubjectTopperClass");
	static String sql;
	...
	private static String getSubjectTopperClass(ResultSet rs) throws SQLException {
		...
		while(rs.next()) {
			    log.debug("Subject name: "+rs.getString("subjectName")+", Student name: "+rs.getString("name")+", Marks: "+rs.getInt("marks"));
			    System.out.println();
