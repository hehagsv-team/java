...
public class OrderServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        ArrayList<OrdersDetailsDto> arrOrders=new ArrayList<OrdersDetailsDto>();
    		...
    		System.out.println("........Username in OrderServlet that is taken from Servlet : "+username);    	
	       ...
	       if(pageButton==null)
	        {
	    		...
	    		request.setAttribute("members", orderDetails);
	        	 ...
	        	 Query createQuery = em.createQuery("SELECT I.Name,I.Price,O.quantity,O.Id,O.orderDate,S.deliverDate,S.shippingStatus FROM HclSkItems I,Orders O,ShippingOrderEntity S WHERE   O.payment=1 AND O.userName=:Username");
...
//					start=start+2;
					 int sizes=resultList.size();
					    System.out.println("the size of the list is "+sizes);
					System.out.println("start value in NEXT ORDERS"+start);
