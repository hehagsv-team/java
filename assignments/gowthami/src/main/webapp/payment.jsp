...
<%
    out.println("order id is : "+request.getAttribute("order"));
%>
	<div class="container">
            <header>
	...
	<form method="POST" ><div >Payment</div>
		    ...
		    <div class="selector"><br><br><br>
		        ...
		        <c:choose>
							<c:when test="${Status == 'Pass'}">
								...
								<center><div class="NextEmpty"><p> Updated Successfully</p></div></center>
			      ...
			      <button type="submit"  name="paymentButton" value="payment" >Payment</button>
		    </div>
	</form>
</body>
</html>