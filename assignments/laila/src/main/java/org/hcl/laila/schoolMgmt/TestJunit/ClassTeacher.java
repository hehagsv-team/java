...
public class ClassTeacher {
	protected static String classdetails(QueryClass queclass,ExecuteClass execlass, PreparedStatement prestat,Connection connection,int number,ResultSet rs, String execute) throws SQLException {
		String method;
