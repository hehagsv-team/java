...
<%-- 			<c:choose>
		...
		<button id="cart-button" name="paymentButton" value="payment" disabled="disabled" onClick=paymentdupDis>Payment</button>
							  ...
							  <c:set var="a" value="1"/>
								...
								<c:forEach items="${member}" var="mem">
									...
									<c:if test="${a == 2}">
									 ...
									 <td><input type="number" id="quantity-text" name="Quantity"></td>
								</tr>
