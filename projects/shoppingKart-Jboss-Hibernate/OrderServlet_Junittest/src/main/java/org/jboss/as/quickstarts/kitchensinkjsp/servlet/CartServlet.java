...
public class CartServlet extends HttpServlet {
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response,EntityManager em) throws ServletException, IOException {
		int start=0;
...
//				String order=request.getParameter("Order_Id");
				logger.info("Current Time in milliseconds = ");
			    ...
			    logger.info("the final time is::"+finaltime);
