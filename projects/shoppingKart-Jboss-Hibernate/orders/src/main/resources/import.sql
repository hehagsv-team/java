...
insert into HCL_SK_ORDER (ITEM_ID,ID,ORDER_DATE,QUANTITY,PAYMENT,USERNAME) values (1,1,DATE '2020-04-07',0,1,'Ashok');  
insert into HCL_SK_ORDER (ITEM_ID,ID,ORDER_DATE,QUANTITY,PAYMENT,USERNAME) values (2,2,DATE '2020-04-01',0,1,'Ashok');  
insert into HCL_SK_ORDER (ITEM_ID,ID,ORDER_DATE,QUANTITY,PAYMENT,USERNAME) values (45,3,DATE '2020-04-08',3,1,'Ashok');
insert into HCL_SK_ORDER (ITEM_ID,ID,ORDER_DATE,QUANTITY,PAYMENT,USERNAME) values (4,4,DATE '2020-04-02',4,1,'Ashok');
insert into HCL_SK_ORDER (ITEM_ID,ID,ORDER_DATE,QUANTITY,PAYMENT,USERNAME) values (5,5,DATE '2020-04-04',5,1,'Ashok');
insert into HCL_SK_ORDER (ITEM_ID,ID,ORDER_DATE,QUANTITY,PAYMENT,USERNAME) values (96,6,DATE '2020-04-03',6,1,'Ashok');
insert into HCL_SK_ORDER (ITEM_ID,ID,ORDER_DATE,QUANTITY,PAYMENT,USERNAME) values (81,8,DATE '2020-04-05',8,1,'Ashok');
insert into HCL_SK_ORDER (ITEM_ID,ID,ORDER_DATE,QUANTITY,PAYMENT,USERNAME) values (110,11,DATE '2020-04-01',6,1,'Ashok');
insert into HCL_SK_ORDER (ITEM_ID,ID,ORDER_DATE,QUANTITY,PAYMENT,USERNAME) values (57,7,NULL,7,0,'Ashok');
insert into HCL_SK_ORDER (ITEM_ID,ID,ORDER_DATE,QUANTITY,PAYMENT,USERNAME) values (34,9,NULL,4,0,'Ashok');
insert into HCL_SK_ORDER (ITEM_ID,ID,ORDER_DATE,QUANTITY,PAYMENT,USERNAME) values (126,10,NULL,4,0,'Ashok');
insert into HCL_SK_ORDER (ITEM_ID,ID,ORDER_DATE,QUANTITY,PAYMENT,USERNAME) values (7,12,DATE '2020-04-06',6,1,'Ashok');
