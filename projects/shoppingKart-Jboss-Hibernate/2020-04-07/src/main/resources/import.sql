...
insert into Item (itemId, name, price) values (1, 'Redmi', 7000 );
insert into Item (itemId, name, price) values (2, 'RealMe', 12000 );
insert into Item (itemId, name, price) values (3, 'Nokia', 15000 );
