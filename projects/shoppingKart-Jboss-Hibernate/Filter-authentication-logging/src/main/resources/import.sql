...
insert into HCL_SK_ORDER(id,status,item_id,order_date,quantity,payment,username) values(1,'progress',2,'05-04-2020',8,0,'Varun')
insert into HCL_SK_ORDER(id,status,item_id,order_date,quantity,payment,username) values(2,'progress',3,'05-04-2020',4,0,'Varun')
insert into HCL_SK_ORDER(id,status,item_id,order_date,quantity,payment,username) values(3,'progress',4,'05-04-2020',5,1,'Hemadri')
insert into HCL_SK_ORDER(id,status,item_id,order_date,quantity,payment,username) values(4,'progress',5,'05-04-2020',7,0,'Hemadri')
insert into HCL_SK_ORDER(id,status,item_id,order_date,quantity,payment,username) values(5,'progress',1,'05-04-2020',9,1,'Varun')

insert into HCL_SK_ORDER(id,status,item_id,order_date,quantity,payment,username) values(6,'progress',6,'05-04-2020',5,1,'Varun')
insert into HCL_SK_ORDER(id,status,item_id,order_date,quantity,payment,username) values(7,'progress',9,'05-04-2020',7,0,'Varun')
insert into HCL_SK_ORDER(id,status,item_id,order_date,quantity,payment,username) values(8,'progress',7,'05-04-2020',9,1,'Abdul')
insert into HCL_SK_ORDER(id,status,item_id,order_date,quantity,payment,username) values(9,'progress',8,'05-04-2020',5,1,'Varun')
insert into HCL_SK_ORDER(id,status,item_id,order_date,quantity,payment,username) values(10,'progress',10,'05-04-2020',7,1,'Varun')
insert into HCL_SK_ORDER(id,status,item_id,order_date,quantity,payment,username) values(11,'progress',11,'05-04-2020',9,1,'Varun')
insert into HCL_SK_ORDER(id,status,item_id,order_date,quantity,payment,username) values(12,'progress',12,'05-04-2020',2,0,'Varun')
