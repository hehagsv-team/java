...
/* 		document.getElementById("mb1").disabled =true;*/
    ...
    <body>
        <div class="container">
			...
			<form name="submitForm1" method="POST" action="/Auth-REST-Refund-Log4j-Junit/BrowseItems">
            <li><a href="javascript:document.submitForm1.submit()">Home</a></li>
			<input type="hidden" name="username" value="${name}">
			</form>
			
			
			   <form name="submitForm3" method="POST" action="/Auth-REST-Refund-Log4j-Junit/orders">
	            <input type="hidden" name="username" value="${name}">
	            <li><a href="javascript:document.submitForm3.submit()">Orders</a></li>
	            </form>
	            
			<form name="submitForm" method="POST" action="/Auth-REST-Refund-Log4j-Junit/cart.do">
            ...
            <div class="right"> 
                <!-- <a href="login">logout</a> -->
                 <form name="submitForm2" method="POST" action="/Auth-REST-Refund-Log4j-Junit/LogoutServlet">
                    ...
                    <tbody>
                      ...
                      <c:forEach items="${members}" var="member">
							  <c:set var="a" value="1"/>
								...
								<tr>								<td><input type="radio" name="adding" value= ${i.getId()} id="adding" onclick="add()"></td>									
