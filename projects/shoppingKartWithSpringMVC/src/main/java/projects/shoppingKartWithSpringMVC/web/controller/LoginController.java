...
//   	   model.put("name",name);
       ...
       public String showWelcomePage(@ModelAttribute("hclSkItems") HclSkItems hclSkItems,final RedirectAttributes redirectAttributes,@RequestParam String name)
       {  	   
...
//       {
    	 public String showPostWelcomePage(ModelMap model,@RequestParam String man_button,@RequestParam Integer text1,@RequestParam Integer text2,@RequestParam String rdbutton,@RequestParam String category)
         {
    	   List<HclSkManufacturer> showIt = service.showManufacturer();
           ArrayList man=new ArrayList();      
           if(showIt.isEmpty())
...
//    	    if((rdbutton.equals("price")) && price_button.equals("price_checker"))
    	    else if((rdbutton.equals("price")) && man_button.equals("Apply"))
    	    {
...
//    	    	   redirectAttributes.addFlashAttribute("price",arrPrice);
    	    ...
    	    else if((rdbutton.equals("manufacturer")) && man_button.equals("Apply")) 
    	    {
    	    	
//    	    	 String manuName="HTC";
    	    	   ArrayList arr=new ArrayList();
    	    	   List<HclSkItems> item=service.displayItemsByManufacturer(category);    	  
    	    	   if(item.isEmpty())
    	    	   {
